...
* BUGFIX: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): fix [`field_max` stats function](https://docs.victoriametrics.com/victorialogs/logsql/#field_max-stats) returning the field value at the row with the minimum source field value instead of the maximum. See [#1294](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1294).
