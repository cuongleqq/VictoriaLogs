...
* BUGFIX: [vlagent](https://docs.victoriametrics.com/victorialogs/vlagent/): fix applying multiple `-fileCollector.excludeGlob` patterns when collecting file logs. See [#1374](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1374).
